...
class SetKey : public QObject, public BaseKey {
...
public:
    explicit SetKey(QObject* parent = nullptr, const QSharedPointer<RedisClient::Connection> connection = Q_NULLPTR, const int& dbNumber = 0, const QByteArray& keyName = "");
    ~SetKey();
