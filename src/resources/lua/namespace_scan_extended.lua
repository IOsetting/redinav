...
repeat
    ...
    for _, key in ipairs(keys) do
        ...
        if ns == nil then
            ...
            local full_abc_ns = string.sub(key, 0, local_key_part_index)
            if abc_namespaces[full_abc_ns] == nil then
                abc_namespaces[full_abc_ns] = 1
            else
                abc_namespaces[full_abc_ns] = abc_namespaces[full_abc_ns] + 1
            end
...
return { cjson.encode(root_namespaces), cjson.encode(root_keys), cjson.encode(abc_namespaces) }
